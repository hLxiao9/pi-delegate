...
- Worker: ${metrics.pi.usage.requests} calls, duration ${metrics.pi.usage.durationMs} ms; Token input ${metrics.pi.usage.inputTokens}, cache read ${metrics.pi.usage.cachedInputTokens}, output ${metrics.pi.usage.outputTokens}
