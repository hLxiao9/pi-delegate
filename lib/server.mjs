...
import { listRunStates, renderDashboardFragment, renderDashboardHtml } from './dashboard.mjs';
  ...
  return async (req, res) => {
    ...
    try {
      if (req.method === 'GET' && url.pathname === '/') {
        ...
        const html = renderDashboardHtml(payload.states, payload.metricsList, payload.generatedAt, { live: true });
